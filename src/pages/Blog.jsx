...
import { saveBlogs } from "../utils/saveBookmark";
        ...
        <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
          <div className="space-y-6">
            ...
            <div className="flex items-start -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
              ...
              <div onClick={()=>handleBookmark(blogId)} className="bg-primary p-3 ml-5 rounded-full hover:bg-opacity-30 bg-opacity-20 cursor-pointer hover:scale-105 overflow-hidden" >
                <MdBookmarkAdd className="text-secondary h-5 w-5" />
              </div>
            </div>
          </div>
        </article>
